...
class _$MovieDetailImpl implements _MovieDetail {
  ...
  @override
  String toString() {
    return 'MovieDetail(id: $id, title: $title, postePath: $postePath, overview: $overview, backdropPath: $backdropPath, runtime: $runtime, voteAverage: $voteAverage, genres: $genres)';
  }
