...
class _$TransactionCopyWithImpl<$Res, $Val extends Transaction>
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      seets: null == seets
          ? _value.seets
          : seets // ignore: cast_nullable_to_non_nullable
              as List<String>,
      ...
      watchingTime: freezed == watchingTime
          ...
          : watchingTime // ignore: cast_nullable_to_non_nullable
              as int?,
      amongTicket: freezed == amongTicket
          ? _value.amongTicket
          : amongTicket // ignore: cast_nullable_to_non_nullable
              as int?,
...
class _$TransactionImpl implements _Transaction {
  ...
  @override
  final String title;
  final List<String> _seets;
  @override
  @JsonKey()
  List<String> get seets {
    if (_seets is EqualUnmodifiableListView) return _seets;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_seets);
  }
  ...
  @override
  String toString() {
    return 'Transaction(id: $id, uid: $uid, transactionTime: $transactionTime, transactionImage: $transactionImage, title: $title, seets: $seets, theaterName: $theaterName, watchingTime: $watchingTime, amongTicket: $amongTicket, ticketPrice: $ticketPrice, adminFee: $adminFee, total: $total)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality().equals(other._seets, _seets) &&
            ...
            (identical(other.amongTicket, amongTicket) ||
                other.amongTicket == amongTicket) &&
  ...
  int get hashCode => Object.hash(
      ...
      transactionImage,
      title,
      const DeepCollectionEquality().hash(_seets),
      theaterName,
      watchingTime,
      amongTicket,
      ticketPrice,
