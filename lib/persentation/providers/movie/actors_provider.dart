import 'package:flix_id_riverpod/domain/entities/actor.dart';
import 'package:flix_id_riverpod/domain/entities/result.dart';
import 'package:flix_id_riverpod/domain/usecases/get_actors/get_actors.dart';
import 'package:flix_id_riverpod/domain/usecases/get_actors/get_actors_param.dart';
import 'package:flix_id_riverpod/persentation/providers/usecase/get_actors_provider.dart';
